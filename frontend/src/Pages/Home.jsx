        ...
        >
          <div className="flex lg:flex-1">
            <Link to="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Paydude</span>
              <img alt="Paydude" src={logo} className="w-auto h-14" />
            </Link>
          </div>
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full px-6 py-6 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <Link to="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Paydude</span>
                <img alt="Paydude" src={logo} className="w-auto h-8" />
              </Link>
              <button
                type="button"
        ...
        <div className="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative px-3 py-1 text-sm leading-6 text-gray-600 rounded-full ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Seamlessly send and receive money with Paydude.{" "}
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Experience the ease of managing your finances with Paydude. Send
              money, pay bills, and keep track of your expenses, all in one
              place.
            </p>
